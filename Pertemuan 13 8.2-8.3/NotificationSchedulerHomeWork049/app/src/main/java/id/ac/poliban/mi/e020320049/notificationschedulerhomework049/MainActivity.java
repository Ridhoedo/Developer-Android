package id.ac.poliban.mi.e020320049.notificationschedulerhomework049;
 ...
 * Answer to question
 *
 * Q1 - What class do you use if you want features like the ones provided by JobScheduler,
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar()
                .setTitle("Job Scheduler Download Homeweork 049");
