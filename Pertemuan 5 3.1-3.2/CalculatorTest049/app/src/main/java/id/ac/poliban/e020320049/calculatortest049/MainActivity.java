...
public class MainActivity extends AppCompatActivity {
    ...
    private Calculator049 mCalculator;
    ...
    public void onAdd(View view) {
        compute(Calculator049.Operator.ADD);
    }
    /**
     * OnClick method called when the subtract Button is pressed.
     */
    public void onSub(View view) {
        compute(Calculator049.Operator.SUB);
    }
    /**
    ...
    public void onDiv(View view) {
        try {
            compute(Calculator049.Operator.DIV);
    ...
    public void onMul(View view) {
        compute(Calculator049.Operator.MUL);
    }
    private void compute(Calculator049.Operator operator) {
        double operandOne;
        double operandTwo;
        try {
