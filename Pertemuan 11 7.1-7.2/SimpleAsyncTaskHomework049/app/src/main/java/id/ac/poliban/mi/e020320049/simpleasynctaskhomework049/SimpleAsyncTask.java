package id.ac.poliban.mi.e020320049.simpleasynctaskhomework049;
...
// first void because no input required; second void because progress is not published;
// string for result type
