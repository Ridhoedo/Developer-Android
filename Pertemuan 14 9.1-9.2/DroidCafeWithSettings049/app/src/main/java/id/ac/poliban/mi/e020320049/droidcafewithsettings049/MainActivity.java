package id.ac.poliban.mi.e020320049.droidcafewithsettings049;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE =
            "id.ac.poliban.mi.e020320049.droidcafewithsettings049.extra.MESSAGE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("DroidCafeWithSettings049");
