package id.ac.poliban.mi.e020320049.recyclerviewespressochallange049;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Recycler View Espresso Challange 049");
