package id.ac.poliban.mi.e020320049.twoactivitiesespresso049;
...
public class SecondActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_REPLY ="id.ac.poliban.mi.e020320049.twoactivitiesespresso049.extra.REPLY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("TwoActivities Received");
