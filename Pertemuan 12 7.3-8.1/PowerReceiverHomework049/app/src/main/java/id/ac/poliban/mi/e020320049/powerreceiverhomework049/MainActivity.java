package id.ac.poliban.mi.e020320049.powerreceiverhomework049;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_RANDOM_NUMBER = "id.ac.poliban.mi.e020320049.powerreceiverhomework049.RANDOM_NUMBER";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("PowerReceiverHomework049");
